...
export const courses: Course[] = [
  ...
  },
  {
    ...
    summary: 'Master modern digital marketing — SEO, paid ads, content, analytics and social — with hands-on campaigns.',
    outcomes: ['Run paid ad campaigns', 'Grow organic traffic', 'Measure with analytics', 'Build a marketing funnel'],
    syllabus: [
      { module: 'Foundations', topics: ['Marketing funnels', 'SEO basics', 'Content strategy'] },
      { module: 'Growth', topics: ['Paid ads', 'Analytics', 'Social & email'] },
    ],
  ...
  },
  {
    ...
    level: 'Beginner',
    duration: '2 months',
    tagline: 'Rank higher and win organic traffic.',
    summary: 'Learn technical and content SEO to grow organic search traffic for any website or product.',
    outcomes: ['Do keyword research', 'Optimise technical SEO', 'Build content that ranks', 'Track rankings & traffic'],
    syllabus: [
      { module: 'SEO Core', topics: ['Keywords & intent', 'On-page SEO', 'Technical SEO'] },
      { module: 'Growth', topics: ['Link building', 'Content SEO', 'Analytics'] },
    ],
